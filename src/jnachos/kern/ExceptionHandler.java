...
public abstract class ExceptionHandler {
	...
	public static void handleException(ExceptionType pException) {
		...
		case PageFaultException:
			// fetch the virtual address which is not present in the Main Memory
			int badAddress = Machine.readRegister(Machine.BadVAddrReg);
			
			//Invoke the Page Fault Handler
			PageFaultHandler.handlePageFault(badAddress);
